...
async function fetchAllPokemons() {
  ...
  for (let i = 0; i < 898; i++) {
    ...
    const pokemonThumbnail = `assets/images/poke-thumbnails-105x105/${pokemonShownID}.webp`;
    const pokemonImage = `assets/images/poke-thumbnails-215x215/${pokemonShownID}.webp`;
